...
echo
echo "${BLUE_TEXT}${BOLD_TEXT}🏗️  Step 4: Creating Dataproc Cluster${RESET_FORMAT}"
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}💖 IF YOU FOUND THIS HELPFUL, SUBSCRIBE ATUL PACHAURI! 👇${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@atulpachauri7132${RESET_FORMAT}"
echo

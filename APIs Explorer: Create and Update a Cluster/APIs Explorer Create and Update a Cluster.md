...
```bash
curl -LO https://github.com/atulpachauri/Google_Arcade/raw/refs/heads/main/APIs%20Explorer%3A%20Create%20and%20Update%20a%20Cluster/APIs_Explorer_Create_and_Update_a_Cluster.sh
sudo chmod +x APIs_Explorer_Create_and_Update_a_Cluster.sh
./APIs_Explorer_Create_and_Update_a_Cluster.sh
```
